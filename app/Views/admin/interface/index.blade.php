    ...
    <script>
        $(document).ready(function(){
            TableDatatablesAjax.init({
                ajaxGet: '{{ asset($adminCpAccess.'/settings/interface') }}',
                src: $('#datatable_ajax'),
                ...
                actionPosition: 6,
                ajaxUrlSaveRow: '{{ asset($adminCpAccess.'/settings/fast-edit-interface') }}'
            });
        });
    </script>
@endsection
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <div class="btn-group btn-group-devided">
                            <a class="btn btn-transparent btn-success btn-circle btn-sm" href="{{ asset($adminCpAccess.'/settings/interface-edit/0/'.$currentLanguageId) }}"><i class="fa fa-plus"></i> Create</a>
                        </div>
                    </div>
                </div>
